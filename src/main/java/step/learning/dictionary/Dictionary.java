...
{
    private static final HashMap _language_dictionary = new HashMap<>()  // Сontains key-value pairs for words and their translations from
    ...
    public Iterator<Map.Entry> _iterator_language_dictionary = _language_dictionary.entrySet().iterator();
